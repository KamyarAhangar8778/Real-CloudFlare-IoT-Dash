/**
 * @file AutomationsFooter.tsx
 * @description Footer component for AutomationsDrawer matching SettingsFooter style.
 */
...
/**
 * AutomationsFooter renders the bottom status indicator and dismiss information.
 */
export function AutomationsFooter() {
  return (
    <div className="border-t border-accent3-medium/20 pt-4 mt-8 text-right space-y-2">
      <div className="flex items-center gap-1.5 justify-end text-[10px] text-accent3">
        <span className="font-bold">موتور اتوماسیون ابری و زمان‌بندی فعال است</span>
