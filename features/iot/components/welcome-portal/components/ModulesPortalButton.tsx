...
export default function ModulesPortalButton({ onClick }: ModulesPortalButtonProps) {
  ...
  return (
    ...
    >
      <div className="p-2 rounded-lg bg-[var(--bg-main)] border border-[var(--border-color)] text-[var(--accent4)] group-md:hover:bg-[var(--accent4-transparent)] transition-colors flex items-center justify-center">
        <ModulesIcon
          size={16}
          animationsEnabled={animationsEnabled}
          className="group-md:hover:translate-x-0.5 transition-transform duration-300"
        />
      </div>
