...
export default function ControlsIsland({ props }: { props: any }) {
  ...
  return (
    <div className={`relative flex-1 bg-[var(--card-bg-solid)]/90 backdrop-blur-md border border-[var(--border-color)] ${isSidebarCollapsed ? "px-2" : "px-5"} py-5 rounded-2xl shadow-sm flex flex-col justify-between gap-4 transition-all duration-350 md:hover:-translate-y-1.5 md:hover:shadow-xl md:hover:border-[var(--accent3)]/50 overflow-hidden`}>
      <HeaderIslandPattern variant="vertical" />
      <div className="relative z-10 flex flex-col gap-4 overflow-y-auto custom-scrollbar pr-1 -mr-1">
        ...
        {isSidebarCollapsed ? (
          <div className="space-y-3 pt-3 border-t border-[var(--border-color)] w-full flex flex-col items-center">
      ...
      <div className="relative z-10 space-y-4 pt-4 border-t border-[var(--border-color)] shrink-0">
