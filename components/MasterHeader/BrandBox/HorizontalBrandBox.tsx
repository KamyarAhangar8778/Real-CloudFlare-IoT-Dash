  ...
  return (
    <div className="relative z-10 flex items-center justify-between md:justify-start gap-4 shrink-0 w-full md:w-auto">
      <div className="relative z-10 flex items-center gap-3">
        <div className="w-10 h-10 bg-transparent border border-[var(--border-color)] rounded-xl shrink-0 flex items-center justify-center overflow-hidden shadow-sm md:hover:border-[var(--accent4)] transition-all">
          <Image
            src="/logo.png"
            alt="Logo"
            width={26}
